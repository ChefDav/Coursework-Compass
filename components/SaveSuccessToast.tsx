...
export default function SaveSuccessToast() {
    ...
    return (
        <section className="cc-panel-strong cc-toast-motion fixed bottom-4 left-3 right-3 z-[70] rounded-[1.5rem] border-emerald-400/30 p-4 sm:bottom-6 sm:left-auto sm:right-6 sm:w-[28rem] sm:rounded-[1.75rem]">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    {toast.actionHref && displayActionLabel ? (
                        <Link
                            ...
                            className="cc-button-success mt-4 rounded-2xl px-4 py-3 text-sm"
                        >
                            {displayActionLabel}
                        </Link>
                    ) : null}
